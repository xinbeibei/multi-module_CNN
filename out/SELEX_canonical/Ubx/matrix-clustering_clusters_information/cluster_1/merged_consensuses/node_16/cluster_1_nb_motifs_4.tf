AC  cluster_1_node_16_4motifs
XX
ID  cluster_1_node_16_4motifs
XX
DE  --tmATaAaTcAw---
P0       a     c     g     t
1        0     0     0     0
...
CC  program: transfac
CC  matrix.nb: 1
CC  accession: cluster_1_node_16_4motifs
CC  AC: cluster_1
CC  id: cluster_1
CC  name: cluster_1_node_16_4motifs
CC  version: 
CC  name: cluster_1_node_16_4motifs
CC  description: --tmATaAaTcAw---
CC  transfac_consensus: 
CC  matrix.nb: 1
CC  consensus.strict: --taATaAaTcAa---
CC  consensus.strict.rc: ---TTGATTTATTA--
CC  consensus.IUPAC: nntmATaAaTcAwnnn
CC  consensus.IUPAC.rc: NNNWTGATTTATKANN
CC  consensus.regexp: [acgt][acgt]t[ac]ATaAaTcA[at][acgt][acgt][acgt]
CC  consensus.regexp.rc: [ACGT][ACGT][ACGT][AT]TGATTTAT[GT]A[ACGT][ACGT]
XX
//
